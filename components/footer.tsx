        ...
        <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div className="flex flex-col items-center border-t pt-6">
            <nav className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6 mb-4">
              ...
              <a href="#" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Tags</a>
              <a href="#" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Projects</a>
          ...
          <div className="text-gray-400 text-sm text-center py-8">© 2023 - Present Syrius. All rights reserved.</div>
        </footer>
      </div>
    </>
  );
